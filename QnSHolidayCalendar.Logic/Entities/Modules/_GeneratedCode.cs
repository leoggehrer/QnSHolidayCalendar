namespace QnSHolidayCalendar.Logic.Entities.Modules.Language
{
	using System;
	partial class Translation : QnSHolidayCalendar.Contracts.Modules.Language.ITranslation
	{
		static Translation()
		{
			ClassConstructing();
		...
		{
			if (!(obj is QnSHolidayCalendar.Contracts.Modules.Language.ITranslation instance))
			{
				return false;
			}
...
namespace QnSHolidayCalendar.Logic.Entities.Modules.Account
{
	using System;
	partial class Login : QnSHolidayCalendar.Contracts.Modules.Account.ILogin
	{
		static Login()
		{
			ClassConstructing();
		...
		public override bool Equals(object obj)
		{
			if (!(obj is QnSHolidayCalendar.Contracts.Modules.Account.ILogin instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
