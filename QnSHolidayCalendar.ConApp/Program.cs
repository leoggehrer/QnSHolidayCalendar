...
using AccountManager = QnSHolidayCalendar.Adapters.Modules.Account.AccountManager;

namespace QnSHolidayCalendar.ConApp
{
    class Program
    {
        static string SaUser => "SysAdmin";
        static string SaEmail => "SysAdmin@QnSHolidayCalendar.gmx.at";
        static string SaPwd => "Sys2189!Admin";
        static bool SaEnableJwt => true;

        static string AaUser => "AppAdmin";
        static string AaEmail => "AppAdmin@QnSHolidayCalendar.gmx.at";
        ...
        {
            await Task.Run(() => Console.WriteLine("QnSHolidayCalendar"));
